    ...
    for stock_id in stock_ids:
        for date in dates:
            ...
            for _ in range(1): 
                ...
                message_content = generate_message_content(stock_id, bps_str, capital_str, roe_str, eps_str, GM_str, OPM_str, DBR_str, summary_str, stock_price, company_background, roa_str, per_str)
