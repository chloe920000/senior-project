...
* If it is bearish, you don't need to answer other questions 2.3.4.5
...
'''
        ...
        input_log_path = os.path.join(result_data_dir, f'input_log_{stock_id}.txt')
        ...
        with open(result_path, 'w', encoding='utf-8') as f:
            async for part in await AsyncClient().chat(model='llama3:8b', messages=[message], stream=True, options={"temperature": 0.35}):
...
def get_stock_predictions(stock_id):
    return asyncio.run(chat(stock_id))